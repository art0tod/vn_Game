...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(245, 340, 440, 70) action Start()
        hotspot(245, 450, 440, 70) action ShowMenu("load")
        hotspot(245, 560, 440, 70) action ShowMenu("preferences")

        hotspot(70, 795, 240, 60) action ShowMenu("about")
        hotspot(70, 870, 240, 60) action ShowMenu("help")
        hotspot(70, 945, 240, 60) action Quit(confirm=False)
